...
from ...utils import is_invisible_watermark_available, logging, scale_lora_layers, unscale_lora_layers
...
def rescale_noise_cfg(noise_cfg, noise_pred_text, guidance_rescale=0.0):
    ...
    """
    std_text = noise_pred_text.std(axis=tuple(range(1, noise_pred_text.ndim)), keepdim=True)
    std_cfg = noise_cfg.std(axis=tuple(range(1, noise_cfg.ndim)), keepdim=True)
