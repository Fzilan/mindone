...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from mindone.diffusers import AutoPipelineForText2Image, ControlNetModel, AutoencoderKL
        ...
        ...     "diffusers/controlnet-canny-sdxl-1.0", mindspore_dtype=mindspore.float16
        ... )
...
class StableDiffusionXLControlNetPAGPipeline(
    ...
    def prepare_latents(self, batch_size, num_channels_latents, height, width, dtype, generator, latents=None):
        ...
        # The above line changes the dtype of latents from fp16 to fp32, so we need a casting.
    ...
    def __call__(
        ...
        Args:
            ...
            image (`ms.Tensor`, `PIL.Image.Image`, `np.ndarray`, `List[ms.Tensor]`, `List[PIL.Image.Image]`, `List[np.ndarray]`,:
                ...
                specified as `mindspore.Tensor`, it is passed to ControlNet as is. `PIL.Image.Image` can also be accepted
